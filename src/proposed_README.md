...
Cue2 is a cross-platform event playback and show control application, inspired by QLab. Built with Godot 4.7.1 Mono, FFmpeg.AutoGen 9.0.1.1, and SDL3-CS 3.4.14.1, it supports audio/video playback, OSC commands, text overlays, session management, and more. Targets Windows 10+, macOS, and Linux.
